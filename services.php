...
<body>
  <div class="container">
    ...
    <div class="services-grid">
      ...
      <a href="appointment.php" class="service-btn">
      ...
      <a href="fund_raise.php" class="service-btn">
        <i class="fas fa-donate service-icon"></i>
      ...
      <a href="report.php" class="service-btn">
        ...
        <span data-translate="service-reports">Reports</span>
      </a>
...
?>
  ...
  const updateLanguage = (lang) => {
    const mapping = {
      ...
      np: {
        ...
        'service-fund-raise': 'फन्ड उठाउने',
  ...
  // Listen for changes to localStorage (e.g., from header.php language switcher)
